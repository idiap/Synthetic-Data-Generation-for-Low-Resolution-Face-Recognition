#
# SPDX-FileCopyrightText: Copyright (c) 2019 Evgeny Nizhibitsky
#
# SPDX-License-Identifier: MIT
#
# Script: iresnet.py
# From pytorch-insightface (https://github.com/nizhib/pytorch-insightface).
#
import torch
...
def _iresnet(arch, block, layers, checkpoint_path=None):
...
def iresnet34(checkpoint_path=None):
    return _iresnet("iresnet34", IBasicBlock, [3, 4, 6, 3], checkpoint_path)


def iresnet50(checkpoint_path=None):
