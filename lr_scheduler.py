...
#
# Script: lr_scheduler.py
# From InsightFace (https://github.com/deepinsight/insightface, MIT); see LICENSES/MIT.txt.
#
...
class PolynomialLRWarmup(_LRScheduler):
    def __init__(self, optimizer, warmup_iters, total_iters=5, power=1.0, last_epoch=-1, verbose=False):
        #super().__init__(optimizer, last_epoch=last_epoch, verbose=verbose) #TypeError correction
