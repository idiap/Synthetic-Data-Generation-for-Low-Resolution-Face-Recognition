...
#
# Script: edgeface_s_gamma_05_PDT_56_cubic_area.py
...
# Data
# --------------------------------------------------------------------------- #
# LR dataset: images downsampled to 56×56 (cubic) then upsampled back to 112×112 (area)
config.rec    = data_path("processed_downsample_56_cubic_area_webface4m")
# HR dataset: original 112×112 images (same identities, same label space)
config.rec_hr = data_path("HR_for_processed_downsample_56_cubic_area_webface4m")
...
#    'lfw':                     ('hr', 'hr'),   # original HR pairs → backbone only
    'lfw_56_lr2lr':            ('lr', 'lr'),   # both images LR-degraded
    'lfw_56_hr2lr_interArea':  ('hr', 'lr'),   # first HR, second LR
    'lfw_7_lr2lr':             ('lr', 'lr'),
...
# Checkpointing
# --------------------------------------------------------------------------- #
config.output         = "edgeface_s_gamma_05_PDT_56_cubic_area/"
