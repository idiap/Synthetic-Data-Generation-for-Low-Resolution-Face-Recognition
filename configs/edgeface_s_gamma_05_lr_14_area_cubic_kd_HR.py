...
#
# Script: edgeface_s_gamma_05_lr_14_area_cubic_kd_HR.py
...
config.resume = True
config.output = 'edgeface_s_gamma_05_lr_14_area_cubic_kd_HR/'
...
config.rec    = data_path("processed_downsample_14_area_cubic_webface4m_kd")  # LR — student input
config.rec_hr = data_path("HR_for_processed_downsample_14_area_cubic_webface4m_kd")                          # HR — teacher input
