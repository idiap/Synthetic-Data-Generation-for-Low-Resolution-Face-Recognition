...
#
# Script: edgeface_s_gamma_05_PDT_28_area_cubic.py
...
# Data
# --------------------------------------------------------------------------- #
# LR dataset: images downsampled to 28×28 (area) then upsampled back to 112×112 (cubic)
config.rec    = data_path("processed_downsample_28_area_cubic_webface4m")
# HR dataset: original 112×112 images (same identities, same label space)
config.rec_hr = data_path("HR_for_processed_downsample_28_area_cubic_webface4m")
...
config.val_pair_modes = {
    ...
    'lfw_28_hr2lr_interArea':  ('hr', 'lr'),   # first HR, second LR
    'lfw_7_lr2lr':             ('lr', 'lr'),
...
# Checkpointing
# --------------------------------------------------------------------------- #
config.output         = "edgeface_s_gamma_05_PDT_28_area_cubic/"
