...
#
# Script: edgeface_s_gamma_05_PDT_14_area_cubic.py
...
# Data
# --------------------------------------------------------------------------- #
# LR dataset: images downsampled to 14×14 (area) then upsampled back to 112×112 (cubic)
...
config.rec_hr = data_path("HR_for_processed_downsample_14_area_cubic_webface4m")
...
config.val_pair_modes = {
    ...
    'lfw_14_lr2lr':            ('lr', 'lr'),   # both images LR-degraded
    'lfw_14_hr2lr_interArea':  ('hr', 'lr'),   # first HR, second LR
    'lfw_7_lr2lr':             ('lr', 'lr'),
...
# Checkpointing
# --------------------------------------------------------------------------- #
config.output         = "edgeface_s_gamma_05_PDT_14_area_cubic/"
